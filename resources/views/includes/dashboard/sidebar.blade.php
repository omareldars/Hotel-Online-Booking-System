            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @if (auth()->user()->hasRole('admin'))
                    <li class="nav-item">
                        <a href="{{ route('dashboard.managers.index') }}" class="nav-link">
                            <i class="nav-icon fas fa-user-cog"></i> <p>Manger</p>
                        </a>
                    </li>
                @endif
                ...
                @if (auth()->user()->hasRole(['admin', 'manager']))
                    <li class="nav-item">
                        <a href="{{ route('dashboard.receptionists.index') }}" class="nav-link">
                            <i class="nav-icon fas fa-user-plus"></i> <p>Receptionists</p>
                        </a>
                    </li>
                @endif
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.floors.index') }}" class="nav-link">
                        <i class="nav-icon fas fa-hotel"></i> <p> Floors </p>
                    </a>
                </li>

                <li class="nav-item">
                    <a href="{{ route('dashboard.rooms.index') }}" class="nav-link">
                        <i class="nav-icon fas fa-bed"></i> <p> Rooms </p>
                    </a>
                </li>
