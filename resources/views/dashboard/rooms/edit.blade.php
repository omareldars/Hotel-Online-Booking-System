                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" name='number' class="form-control" placeholder="Number Or Room" value="{{ old('number') ?? $room->number }}">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="number" name='size' class="form-control" placeholder="size of Room : " value="{{ old('size') ?? $room->size }}">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name="price" class="form-control" placeholder="Price of Room 00.00$:" value="{{ old('price') ?? $room->price }}">
                            </div>
