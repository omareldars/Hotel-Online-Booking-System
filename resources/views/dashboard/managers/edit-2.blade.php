    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title pt-2">Edit Manager | {{ $manager->name }}</h3>
            ...
            <form class="p-3" action="{{ route('dashboard.managers.update', $manager) }}" method="post"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name='phone' class="form-control" placeholder="Phone :" value="{{ old('phone') ?? $manager->phone }}">
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" name='national_id' class="form-control" value="{{ old('national_id') ?? $manager->national_id }}" placeholder="Your National ID">
                            </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="role">
                                        <optgroup label="Select Role">
                                            <option value="manager" {{ old('role')  == 'manager' || $manager->hasRole('manager') ? 'selected' : '' }}>Manager</option>
                                            <option value="receptionist" {{ old('role') || $manager->hasRole('receptionist') == 'receptionist' ? 'selected' : '' }}>Receptionist</option>
                                        </optgroup>
                                    </select>
                                </div>
